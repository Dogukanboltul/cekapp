...
const FactoringPreview = () => (
  <div className="mt-6 p-6 rounded-[2.5rem] bg-gradient-to-br from-[#1a1a2e] to-black border border-amber-500/20 shadow-2xl relative overflow-hidden group">
    ...
    <div className="relative z-10 space-y-4">
      <div className="flex items-center justify-between border-b border-white/5 pb-3">
        ...
        <div className="px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-[8px] text-amber-500 font-black italic uppercase">Canlı Skorlama</div>
      </div>
    ...
    <div className="min-h-screen flex flex-col bg-[#060a14] text-slate-100 font-sans uppercase tracking-tighter overflow-x-hidden selection:bg-teal-500/30">
      ...
      <header className="w-full py-4 md:py-8 px-4 md:px-6 flex justify-between items-center border-b border-white/5 sticky top-0 z-50 bg-[#060a14]/90 backdrop-blur-md">
        <div className="flex flex-col">
          ...
          <span className="text-[8px] font-bold text-teal-500/50 tracking-[0.3em] mt-1 uppercase italic">Risk & Liquidity Unit</span>
        </div>
      ...
      <main className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-6 py-6 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="order-2 lg:order-3 lg:col-span-1 flex flex-col gap-6">
             ...
             {/* İŞTE PAGE.TS'DE SATIŞI YAPAN FACTORING PREVIEW */}
             <div className="relative">
                ...
                <FactoringPreview />
                <p className="mt-3 px-6 text-[9px] font-bold text-slate-500 italic uppercase leading-tight">
